				...
				if (newQueue.repeatMode == 0) {
					...
					message.reply({
						embeds: [new MessageEmbed()
						  .setColor(ee.color)
						  .setTimestamp()
						  .setTitle(`<:green:952266816590336090> **Enabled the __Song__-Loop** ||(<:1red:951744145951694858> Disabled the **Queue-Loop**)||`)
						  .setFooter(`💢 Action by: ${member.user.tag}`, member.user.displayAvatarURL({dynamic: true}))]
						})
				} else {
					message.reply({
						embeds: [new MessageEmbed()
						  .setColor(ee.color)
						  .setTimestamp()
						  .setTitle(`<:green:952266816590336090> **Enabled the __Queue__-Loop!** ||(<:1red:951744145951694858> Disabled the **Song-Loop**)||`)
						  .setFooter(`💢 Action by: ${member.user.tag}`, member.user.displayAvatarURL({dynamic: true}))]
						})
				}
			} catch (e) {
