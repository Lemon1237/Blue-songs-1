...
module.exports = async (client) => {
      ...
      .on(`finish`, queue => {
        queue.textChannel.send({
          embeds: [
            ...
            .setDescription("<a:emoji_110:956688446657822730> **There are no more songs left**")
            .setTimestamp()
          ]
        })
      })
  ...
  function receiveQueueData(newQueue, newTrack) {
    ...
    var embed = new MessageEmbed()
      .setDescription(`<:green:952266816590336090> **${newTrack.name}** __added to the queue__ <a:emoji_110:956688446657822730> **(${newTrack.duration})**`);
    return {
      embeds: [embed]
    };
  }
